...
L["\"Drag to set the battlefield map size.|n|nIf the map is unlocked, you can also resize the battlefield map by dragging the bottom-right corner."] = "拖動來設定戰場地圖大小。|n|n如果地圖已解鎖，您還可以通過拖動右下角來調整戰場地圖的大小。"
