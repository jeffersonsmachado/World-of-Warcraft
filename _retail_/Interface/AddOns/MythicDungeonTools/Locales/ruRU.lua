...
L["ConnectedTip"] = "Группы, обведенные в МДТ, не соответствуют объединению НИП в игре."
...
L["freeholdBeguilingPatrolNote"] = "Неделя 2/5/8/11: G53 неподвижен при Посланнице глубин 13"
...
L["helpPlateNPC"] = "Щелкните, чтобы выбрать врагов%sCTRL+ЛКМ, чтобы выбрать одного врага%sSHIFT+ЛКМ, чтобы выбрать врагов и создать новый пул"
L["helpPlatePresets"] = "Управляйте, делитесь и разрабатывайте маршруты"
L["helpPlatePulls"] = "Создавайте пулы и управляйте ими%sЩелкните ПКМ, чтобы открыть дополнительные параметры"
L["Helya"] = "Хелия"
...
L["Hold SHIFT to create a new pull while selecting enemies."] = "Зажмите SHIFT, чтобы создавать отдельные пулы при выборе врагов"
L["Hold SHIFT to delete all presets with the delete preset button."] = "Зажмите SHIFT, чтобы удалить все маршруты при помощи кнопки \"удалить маршрут\"."
...
L["Lakesis"] = "Лакезис"
L["Language"] = "Язык"
L["LargePresetWarning"] = "Вы пытаетесь поделиться очень большим маршрутом (%d символов)\\nВам рекомендуется использовать функцию экспорта и делиться крупными шаблонами, используя внешние сайты \\nВы уверены, что хотите поделиться этим маршрутом?\\n"
...
L["Mouseover the Live button while in a group to learn more about Live mode."] = "Наведите указатель мыши на кнопку 'Прямой эфир' во время нахождения в группе, чтобы узнать больше о 'Прямом эфире'"
...
L["Pull Drop Insert after"] = "Вставить после"
L["Pull Drop Insert before"] = "Вставить перед"
...
L["Redo"] = "Повторить"
L["redoDrawing"] = "Переделать рисунок"
...
L["Right click a pull for more options."] = "Щелкните ПКМ, чтобы открыть дополнительные параметры."
L["Right click an enemy to open the enemy info window."] = "Нажмите ПКМ на противника, чтобы открыть окно информации"
L["Right click for more info"] = "Щелкните ПКМ для получения дополнительной информации"
L["Right-click to lock Minimap Button"] = "[ПКМ] - заблокировать кнопку миникарты"
L["Right-Click to reset NPC position"] = "Щелкните ПКМ, чтобы сбросить положение NPC"
...
L["Shift-Click to delete all presets for this dungeon"] = "Shift-Клик, чтобы удалить все маршруты для этого подземелья"
...
L["siegeDuplicateNote"] = "G39 можно продублировать, если в области есть локальное задание"
...
L["tdWardenFightingNote"] = "G23 сражается и в конечном итоге убьет Надзирателя блока 1"
L["Teeming"] = "Кишащий"
...
L["wcmWorldquestNote"] = "Примечание к G52:%sG52 не будет присутствовать, пока активно локальное задание на победу над Матроной Кристиан."
...
L["You can always return to the current Live Session preset by clicking the 'Return to Live' button next to the preset-dropdown"] = "Вы всегда можете вернуться к шаблону 'Прямая трансляция', нажав на кнопку 'Вернуться к Прямой трансляции'"
